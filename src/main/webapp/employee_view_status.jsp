...
<tr><td>Id</td><td>EmployeeName</td><td>FromDate</td><td>ToDate</td><td>Department</td><td>Status</td></tr>
<%
...
PreparedStatement ps = connection.prepareStatement("select * from leaves where eid = ?");
ps.setInt(1,id);
